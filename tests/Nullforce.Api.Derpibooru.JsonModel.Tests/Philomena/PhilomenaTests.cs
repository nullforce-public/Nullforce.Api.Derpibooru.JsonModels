...
public class PhilomenaTests
{
    ...
    [Fact]
    public async Task CommentRoot_GetJson_SuccessWithoutExceptions()
    {
    ...
    [Fact]
    public async Task GallerySearchRoot_GetJson_SuccessWithoutExceptions()
    {
    ...
    [Fact]
    public async Task ImageRoot_GetJson_SuccessWithoutExceptions()
    {
        ...
        using (new AssertionScope())
        {
            ...
            image.SourceUris.Should().HaveCount(3);
            image.SourceUris.Should().Contain("http://yakovlev-vad.deviantart.com/art/Favorite-place-Color-Sketch-668408843");
    ...
    [Fact]
    public async Task Oembed_GetJson_SuccessWithoutExceptions()
    {
        ...
        using (new AssertionScope())
        {
            ...
            oembed.Height.Should().Be(1845);
            oembed.ProviderName.Should().Be("Derpibooru");
            oembed.ProviderUri.Should().Be("https://derpibooru.org");
            oembed.ThumbnailHeight.Should().Be(1024);
            oembed.ThumbnailUri.Should().Be("https://derpicdn.net/img/2017/3/11/1384692/large.png");
            oembed.ThumbnailWidth.Should().Be(777);
            oembed.Title.Should().StartWith("#1384692");
            oembed.Type.Should().Be("photo");
            oembed.Uri.Should().Be("https://derpicdn.net/img/view/2017/3/11/1384692.png");
            oembed.Version.Should().Be("1.0");
            oembed.Width.Should().Be(1400);
        }
    }

    [Fact]
    public async Task PostsSearchRoot_GetJson_SuccessWithoutExceptions()
    {
    ...
    [Fact]
    public async Task ProfileRootJson_GetJson_SuccessWithoutExceptions()
    {
        ...
        using (new AssertionScope())
        {
            ...
            award.ImageUri.Should().Be("https://derpicdn.net/badges/2016/10/3/135869b76b1b1cb145181e2.svg");
    ...
    [Fact]
    public async Task TagSearchRoot_GetJson_SuccessWithoutExceptions()
    {
        ...
        using (new AssertionScope())
        {
            ...
            tag.Description.Should().Be(">>3501029s>>2768148s");
            ...
            tag.ImpliedTags.Should().HaveCount(1);
            tag.ImpliedTags.Should().Contain("g4");
            tag.Name.Should().Be("fluttershy");
            tag.NameInNamespace.Should().Be("fluttershy");
            tag.Namespace.Should().BeNull();
            tag.ShortDescription.Should().BeNull();
